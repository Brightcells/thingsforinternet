...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlogSelectedInfo'
        db.create_table(u'exchange_blogselectedinfo', (
        ...
        db.send_create_signal(u'exchange', ['BlogSelectedInfo'])


    def backwards(self, orm):
        # Deleting model 'BlogSelectedInfo'
        db.delete_table(u'exchange_blogselectedinfo')
    ...
    models = {
        u'accounts.userinfo': {
            ...
            'search_engine': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'exchange.bloginfo': {
            'Meta': {'object_name': 'BlogInfo'},
            'blog': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'exchange.blogselectedinfo': {
            'Meta': {'object_name': 'BlogSelectedInfo'},
