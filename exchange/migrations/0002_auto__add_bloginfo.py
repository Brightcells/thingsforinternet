...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlogInfo'
        db.create_table(u'exchange_bloginfo', (
            ...
            ('blog', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'exchange', ['BlogInfo'])


    def backwards(self, orm):
        # Deleting model 'BlogInfo'
        db.delete_table(u'exchange_bloginfo')
