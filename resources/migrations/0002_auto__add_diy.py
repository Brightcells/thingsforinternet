...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DIY'
        db.create_table(u'resources_diy', (
            ...
            ('website', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='diy_website', null=True, to=orm['resources.WebSiteInfo'])),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modify_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'resources', ['DIY'])


    def backwards(self, orm):
        # Deleting model 'DIY'
        db.delete_table(u'resources_diy')
