...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NavInfo.qiniu_image'
        db.add_column(u'navinfo', 'qiniu_image',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NavInfo.qiniu_image'
        db.delete_column(u'navinfo', 'qiniu_image')
    ...
    models = {
        ...
        u'resources.navinfo': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'position': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'qiniu_image': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'resources.taginfo': {
