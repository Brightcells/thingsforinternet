...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResumeInfo'
        db.create_table(u'resume_resumeinfo', (
        ...
        db.send_create_signal(u'resume', ['ResumeInfo'])


    def backwards(self, orm):
        # Deleting model 'ResumeInfo'
        db.delete_table(u'resume_resumeinfo')
