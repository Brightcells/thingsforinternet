...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.search_engine'
        db.add_column(u'userinfo', 'search_engine',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.search_engine'
        db.delete_column(u'userinfo', 'search_engine')
