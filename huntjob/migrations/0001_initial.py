...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'huntjob_questioninfo', (
        ...
        db.send_create_signal(u'huntjob', ['QuestionInfo'])


    def backwards(self, orm):
        # Deleting model 'QuestionInfo'
        db.delete_table(u'huntjob_questioninfo')
